...
var require_d3 = __commonJS({
  "node_modules/d3/d3.js"(exports, module) {
    !function() {
      ...
      d3.geo.bounds = /* @__PURE__ */ function() {
      ...
      function d3_geo_clipPolygon(segments, compare, clipStartInside, interpolate, listener) {
        ...
        segments.forEach(function(segment) {
          ...
          if (d3_geo_sphericalEqual(p0, p1)) {
            listener.lineStart();
            for (var i2 = 0; i2 < n2; ++i2) listener.point((p0 = segment[i2])[0], p0[1]);
            listener.lineEnd();
            return;
          }
          ...
          function ringEnd() {
            ...
            if (clean & 1) {
              ...
              if (n > 0) {
                if (!polygonStarted) listener.polygonStart(), polygonStarted = true;
                listener.lineStart();
                while (++i < n) listener.point((point2 = segment[i])[0], point2[1]);
                listener.lineEnd();
              }
              return;
            }
  ...
  "node_modules/topojson/build/topojson.js"(exports, module) {
    (function(global, factory) {
      ...
      function meshArcs(topology, o, filter) {
        ...
        function geometry(o2) {
          if (o2.type === "GeometryCollection") o2.geometries.forEach(geometry);
          else if (o2.type in geometryType) geom = o2, geometryType[o2.type](o2.arcs);
        }
        if (arguments.length > 1) {
          var geomsByArc = [], geom;
          var geometryType = {
      ...
      function minAreaHeap() {
        ...
        heap.remove = function(removed) {
          ...
          if (i !== --size) object2 = array[size], (compareArea(object2, removed) < 0 ? up : down)(array[object2._ = i] = object2, i);
          return i;
        };
  ...
  "node_modules/datamaps/dist/datamaps.all.js"(exports, module) {
    (function() {
      ...
      function addContainer(element, height, width) {
        this.svg = d3.select(element).append("svg").attr("width", width || element.offsetWidth).attr("data-width", width || element.offsetWidth).attr("class", "datamap").attr("height", height || element.offsetHeight).style("overflow", "hidden");
      ...
      function handleGeographyConfig() {
        ...
        if (options.highlightOnHover || options.popupOnHover) {
          svg2.selectAll(".datamaps-subunit").on("mouseover", function(d) {
            ...
            if (options.popupOnHover) {
              self.updatePopup($this, d, options, svg2);
            }
      ...
      function addLegend(layer, data, options) {
        ...
        html += "</dl>";
        var hoverover2 = d3.select(this.options.element).append("div").attr("class", "datamaps-legend").html(html);
      }
      ...
      function handleArcs(layer, data, options) {
        ...
        arcs.enter().append("svg:path").attr("class", "datamaps-arc").style("stroke-linecap", "round").style("stroke", function(datum) {
          ...
          if (typeof datum.origin === "string") {
            switch (datum.origin) {
              ...
              case "VNM":
                ...
                break;
              default:
                originXY = self.path.centroid(svg2.select("path." + datum.origin).data()[0]);
            }
          } else {
          ...
          if (typeof datum.destination === "string") {
            switch (datum.destination) {
              ...
              case "VNM":
                ...
                break;
              default:
                destXY = self.path.centroid(svg2.select("path." + datum.destination).data()[0]);
            }
          } else {
          ...
          var $this = d3.select(this);
          if (options.popupOnHover) {
            self.updatePopup($this, datum, options, svg2);
          }
      ...
      function handleBubbles(layer, data, options) {
        var self = this, fillData = this.options.fills, filterData = this.options.filters, svg2 = this.svg;
        if (!data || data && !data.slice) {
        ...
        bubbles.enter().append("svg:circle").attr("class", "datamaps-bubble").attr("cx", function(datum) {
          ...
          if (datumHasCoords(datum)) {
            ...
            if (datum.centered === "USA") {
              ...
              latLng = self.path.centroid(svg2.select("path." + datum.centered).data()[0]);
            }
          }
      ...
      Datamap.prototype.resize = function() {
        ...
        if (options.responsive) {
          var newsize = options.element.clientWidth, oldsize = d3.select(options.element).select("svg").attr("data-width");
      ...
      Datamap.prototype.draw = function() {
        ...
        function draw(data) {
          if (self.options.dataUrl) {
            d3[self.options.dataType](self.options.dataUrl, function(data2) {
              if (self.options.dataType === "csv" && (data2 && data2.slice)) {
                var tmpData = {};
                for (var i = 0; i < data2.length; i++) {
                  tmpData[data2[i].id] = data2[i];
                }
                data2 = tmpData;
              }
              Datamaps.prototype.updateChoropleth.call(self, data2);
            });
          }
      ...
      Datamap.prototype.updateChoropleth = function(data, options) {
        ...
        for (var subunit in data) {
          if (data.hasOwnProperty(subunit)) {
            ...
            svg2.selectAll("." + subunit).transition().style("fill", color);
          }
        }
      };
...
export default require_datamaps_all();
//# sourceMappingURL=datamaps.js.map
